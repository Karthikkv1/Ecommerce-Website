    ...
    <tbody class="bg-secondary text-light">
        ...
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            <tr class="text-center">
                ...
                <td><a href='index.php?edit_brands=<?php echo $brand_id ?>' class='text-danger'><i
                            class='fa-solid fa-pen-to-square'></i></a></td>
                <td><a href='index.php?delete_brands=<?php echo $brand_id ?>' type="button" class="text-danger "
