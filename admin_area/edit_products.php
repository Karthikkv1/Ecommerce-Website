<!-- File created on 23-02-2024 9:09PM -->
...
if(isset($_GET['edit_products'])){
    ...
    // echo $product_title; //10:26PM 23-02-2024
    ...
    //Fetching category Name //10:40PM 23-02-2024
    ...
    echo $category_title;
     ...
     //Fetching Brand Name //10:48PM 23-02-2024
     $select_category="Select * from `brands` where brand_id=$brand_id";
     $result_category=mysqli_query($con,$select_category);
     $row_category=mysqli_fetch_assoc($result_category);
...
<div class="container mt-5">
    ...
    <form action="" method="post" enctype="multipart/form-data">
        ...
        <div class="form-outline w-50 m-auto mb-4">
            ...
            <div class="d-flex">
                <input type="file" id="product_image1" name="product_image1" class="form-control w-90 m-auto"
                    required="required"> <!--To place image input box and image side by side -->
        ...
        <div class="form-outline w-50 m-auto mb-4">
            ...
            <div class="d-flex">
                <input type="file" id="product_image2" name="product_image2" class="form-control w-90 m-auto" required="required"> <!--To place image input box and image side by side -->
        ...
        <div class="form-outline w-50 m-auto mb-4">
            ...
            <div class="d-flex">
                <input type="file" id="product_image3" name="product_image3" class="form-control w-90 m-auto" required="required"> <!--To place image input box and image side by side -->
        ...
        <div class="w-50 m-auto"> <!--To keep the button on the side of the form 23-02-2024 10:01PM-->
